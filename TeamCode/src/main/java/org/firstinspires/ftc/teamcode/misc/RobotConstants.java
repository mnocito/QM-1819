...
public class RobotConstants {
    ...
    public static double NOMSERVO_UP = .875;
    public static double NOMSERVO_DOWN = .225;
    public static double NOMSERVO_NEUTRAL = .45;
    public static double PLACEMENTSERVO_PLACE = .1;
    public static double PLACEMENTSERVO_RECEIVE = .6;
    ...
    public static int MIN_EXTEND_TICKS = 300;
